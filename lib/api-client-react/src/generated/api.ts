 ...
 */
export const createInquiry = async (inquiryInput: InquiryInput, options?: Parameters<typeof customFetch>[1]): Promise<InquiryAccepted> => {

  return customFetch<InquiryAccepted>(getCreateInquiryUrl(),
  {
    ...options,
    method: 'POST',
